...
{
    public class ListBuyCarModel : PageModel
    {
        public readonly UserRepository _userRepo;
        public readonly BookingRepository _bookingRepo;

        public ListBuyCarModel(UserRepository userRepo, BookingRepository bookingRepo)
        {
            _userRepo = userRepo;
        ...
        public async Task<IActionResult> OnGetAsync(int? pageIndex)
        {
            ...
            var list = from b in _bookingRepo.GetAll()
                ...
                .Where(b => b.Username.Equals(user.Username) && b.Notification == 3)
